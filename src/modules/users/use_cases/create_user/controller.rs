...
use crate::modules::users::use_cases::create_user::view::{UserCreatedResponse, UserCreateRequestBody};
...
const INSERT_USER_ALLOWED_FIELDS: &[&str] = &[
    "email",
    "username",
    "first_name",
    "last_name",
...
pub fn handle(payload: Value) -> Result<UserCreatedResponse, CommonErrors> {
    ...
    let user_create_request: UserCreateRequestBody = serde_json::from_value(payload).map_err(|e| CommonErrors::ValidationError)?;
